...
class StandardRobot(Robot):
    ...
    def updatePositionAndClean(self):
        ...
        been cleaned.
        """
        new_position = self.getRobotPosition().getNewPosition(
...
def showPlot1(title, x_label, y_label):
    ...
    for num_robots in num_robot_range:
        ...
        times1.append(runSimulation(num_robots, 1.0, 20, 20,
                                    0.8, 20, StandardRobot))
        times2.append(runSimulation(num_robots, 1.0, 20, 20,
                                    0.8, 20, RandomWalkRobot))
...
def showPlot2(title, x_label, y_label):
    ...
    for width in [10, 20, 25, 50]:
        ...
        times1.append(runSimulation(2, 1.0, width, height,
                                    0.8, 200, StandardRobot))
        times2.append(runSimulation(2, 1.0, width, height,
                                    0.8, 200, RandomWalkRobot))
