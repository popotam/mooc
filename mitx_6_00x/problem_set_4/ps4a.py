...
def isValidWord(word, hand, wordList):
    ...
    if word not in wordList:
        return False
    for key, value in getFrequencyDict(word).iteritems():
        if key not in hand:
            return False
        if hand[key] < value:
            return False
...
def calculateHandlen(hand):
    ...
    returns: integer
    """
    return sum(count for count in hand.itervalues())
...
def playHand(hand, wordList, n):
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    # the number of letters left in your hand and the total score
    total_score = 0
    ...
    print "Run out of letters. Total score: %i points." % total_score
...
def playGame(wordList):
    ...
    hand = None
    while True:
        print ("Enter n to deal a new hand, r to replay the last hand, "
               "or e to end game: "),
